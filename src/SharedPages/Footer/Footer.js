...
const Footer = () => {
    return (
        // bg-[#184B71]
        <div className='lg:pt-20 pt-10  bg-white '>
            <footer className="footer   py-10 lg:px-[10%] px-10 bg-[#202633] text-white   ">
                <div>
                ...
                <div>
                    ...
                    <div className=''>
                        <div>
                            ...
                            <Link to="/notice" className='hover:text-white hover:tracking-widest hover:duration-500'><AiOutlineArrowRight className='inline mb-1 mr-2' />
                                Notice</Link>
                        </div>

                        <div className='mt-3'>

                            <Link to="/contact" className='hover:text-white hover:tracking-widest hover:duration-500'> <AiOutlineArrowRight className='inline mb-1 mr-2' />
                                Contact</Link>
                        </div>
                        <div className='mt-3'>

                            <Link to="/faculty" className='hover:text-white hover:tracking-widest hover:duration-500'> <AiOutlineArrowRight className='inline mb-1 mr-2' /> Faculty</Link>
                        </div>
                        <div className='mt-3'>
                            <Link to="/new_and_events" className='hover:text-white hover:tracking-widest hover:duration-500'> <AiOutlineArrowRight className='inline mb-1 mr-2' /> News </Link>
                        </div>
                        <div className='mt-3'>
                            <Link to="/research" className='hover:text-white hover:tracking-widest hover:duration-500'> <AiOutlineArrowRight className='inline mb-1 mr-2' /> Research</Link>
                        </div>
                    </div>
                    {/* link */}
